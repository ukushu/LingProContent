...
<table class="articlesTbl">
  ...
  <tr>
    ...
    <td class="grayText">Коли співбесідник розуміє, про який саме предмет йде мова</td>
    <td>Про множину: лише якщо співбесідник розуміє про яку групу предметів йдеться (напр. "порубай (он ті конкретні) гілки")</td>
  </tr>
  <tr>
    <td colspan="4" class="grayText">Коли множина - "a" артикль не використовується НІКОЛИ; </td>
  </tr>
</table>
