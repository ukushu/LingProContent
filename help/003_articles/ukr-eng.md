...
<table class="articlesTbl">
  ...
  <tr>
    ...
    <td class="grayText">Коли співбесідник розуміє, про який саме предмет йде мова</br>Про множину: лише якщо співбесідник розуміє про яку групу предметів йдеться (напр. "порубай (он ті конкретні) гілки") </td>
  </tr>
  <tr>
